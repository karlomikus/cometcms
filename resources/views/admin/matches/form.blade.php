    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8" id="match-form">
                ...
                <h3>2. Match players</h3>
                <hr/>
                <h3>3. Match games</h3>
                <hr/>
                <a href="#" class="btn btn-success pull-right" data-bind="click: addRound"><i
                ...
                <div class="tab-content" data-bind="foreach: rounds">
                    <div class="tab-pane" data-bind="attr: { id: 'round' + $index() }">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button class="btn btn-success pull-right" data-bind="click: addScore"><i
